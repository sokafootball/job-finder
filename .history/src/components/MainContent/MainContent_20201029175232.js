    ...
    return (
      <div id="main">
        <SearchForm
          ...
          userInput={userInput}
        />
        {gotResponse ? jobCards : <div><p id="error">Sorry, it seems the server has some issues, please try again later.</p><img src="https://tenor.com/view/kitty-roll-silly-cartoon-cat-gif-5399276"></img></div>}
      </div>
    )
}
