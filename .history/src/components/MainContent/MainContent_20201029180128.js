    ...
    return (
      <div id="main">
        <SearchForm
          ...
          userInput={userInput}
        />
        {gotResponse ? jobCards : <div><p id="error">Sorry, it seems the server has some issues, please try again later.</p><img  src="https://media4.giphy.com/media/UQlmhwP5VYidlnejVR/giphy.gif?cid=ecf05e47zauvj6vfcg240wl8w83wwxo4jtqc3d2sjbs0boky&rid=giphy.gif"></img></div>}
      </div>
    )
}
